...
!function (factory) {
  if (typeof require === 'function' && typeof module !== 'undefined') {
    ...
    // AMD loader
    define('vertx-mail-service-js/mail_service-proxy', [], factory);
  } else {
    // plain old include
    MailService = factory();
  }
  ...
  var MailService = function(eb, address) {
    ...
    this.send = function(options, resultHandler) {
      ...
      if (__args.length === 2 && typeof __args[0] === 'object' && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"options":__args[0]}, {"action":"send"}, function(err, result) { __args[1](err, result &&result.body); });
        return;
