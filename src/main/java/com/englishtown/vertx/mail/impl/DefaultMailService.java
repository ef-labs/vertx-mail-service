...
public class DefaultMailService implements MailService {
    ...
    public static final String MAIL_SMTP_READ_TIMEOUT = "mail.smtp.timeout";
    ...
    public static final String CONFIG_FIELD_SMTP_READ_TIMEOUT = "smtp_read_timeout";
    ...
    private void initSession() {
        ...
        props.put(MAIL_SMTP_READ_TIMEOUT, Integer.toString(config.getInteger(CONFIG_FIELD_SMTP_READ_TIMEOUT, DEFAULT_SMTP_READ_TIMEOUT)));
